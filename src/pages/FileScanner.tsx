...
export function FileScanner() {
  ...
  const handleFileSelected = async (
    ...
    try {
      ...
      /*
      |--------------------------------------------------------------------------
      | Step 1 — Upload the REAL file directly to Vercel Blob
      |--------------------------------------------------------------------------
      */
        ...
        file,
        {
          ...
          onUploadProgress: (event) => {
            if (event.percentage !== undefined) {
              setProgress(
                Math.min(75, 10 + event.percentage * 0.65)
              );
            }
          },
        }
      ...
      /*
      |--------------------------------------------------------------------------
      | Step 2 — Tell our backend about the uploaded REAL file
      |--------------------------------------------------------------------------
      */
      ...
      if (
        ...
        throw new Error(
          scanData.message || 'File scan failed'
        );
      }

      setProgress(100);

      const scan: BackendScan = scanData.scan;
      ...
      <GlassCard className="relative overflow-hidden">
        ...
        <div className="relative flex flex-col items-center py-6 text-center">
          ...
          <h3 className="text-lg font-semibold text-white">
            ...
            {state === 'scanning' && 'Uploading & scanning…'}
